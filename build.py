...
REFS = [
 ...
 dict(key="reflow", years="2022 – 2026", client="Kurtz Ersa",
  de=("Reflow-Ofen-Monitoring", "Integriertes Monitoringsystem zur prädiktiven Bewertung von Lötqualitätsfaktoren an Reflow-Anlagen, aufgebaut auf dem Edge-Compute. Inklusive EMV-Zertifizierung in China."),
  en=("Reflow oven monitoring", "Integrated monitoring system for predictive assessment of solder-quality factors on reflow machines, built on the Edge-Compute. Including EMC certification in China."),
  zh=("回流焊炉监测系统", "基于 Edge-Compute 的集成监测系统，用于回流焊设备焊接质量因素的预测性评估。含在中国完成的 EMC 认证。"),
  links=[("EMV-Story","https://maxclerkwell.tech/posts/dongguan-emc-march-2026/")]),
 dict(key="horus", years="laufend", client="Kurtz Ersa / GlobalPoint",
  de=("HORUS Monitoring & Profiling", "Produktionsreife Observability- und Telemetrie-Infrastruktur sowie ein Performance-Profiling-Stack für eingebettete und verteilte Systeme."),
  en=("HORUS Monitoring & Profiling", "Production-grade observability and telemetry infrastructure plus a performance-profiling stack for embedded and distributed systems."),
  zh=("HORUS 监测与性能分析", "面向嵌入式与分布式系统的生产级可观测性/遥测基础设施及性能剖析栈。"),
  links=[]),
...
def content(lang):
    ...
    C["team"] = dict(
      ...
      people=[
        ...
        dict(id="tabea-boekelmann", pid=PERSON_TABEA, name="Tabea Bökelmann", img=None,
        ...
        dict(id="meihui-huang", pid=PERSON_MEIHUI, name="Meihui Huang", img=None,
        ...
        dict(id="vanessa-wilcken", pid=PERSON_VANESSA, name="Vanessa Wilcken", img=None,
