...
REFS = [
 ...
 dict(key="reflow", years="2022 – laufend", client="Kurtz Ersa / globalPoint ICS",
  ...
  zh=("globalPoint horus® – 回流焊温度曲线与过程监测", "用于回流焊炉焊接曲线创建与持续过程监测的测量电子设备与监测基础设施（2023 年 Productronica 创新奖）：带 Wi-Fi 的电池供电温度曲线电子设备、用于焊接质量预测评估的遥测与可观测性栈、云端集成。含在中国完成的 EMC 认证。"),
 ...
 dict(key="kelvion", years="2023", client="Kelvion",
  ...
  zh=("用于空冷器的红外干涉成像系统", "用于远程评估空冷器（air-fin cooler）结垢状况的相机系统——涵盖光学、嵌入式电子系统与数据分析，适用于工业装置现场。"),
  links=[]),
...
def content(lang):
    ...
    C["leistungen"] = dict(
      ...
      blocks={"de":[
        ...
        ("3. 认证",["EMC 测试准备与实验室现场支持","CE、FCC、CCC 符合性评估及相关技术文档","具备在德国和中国开展测试的经验"]),
        ("4. 软件启动调试",["微控制器：裸机、RTOS、引导加载程序","FPGA：VHDL/Verilog、比特流流水线","Zynq：FSBL/U-Boot、设备树、带 SBOM 的 Yocto Linux","版本化、可复现的工具链"]),
        ("5. 固件",["驱动程序、通信协议及测量数据链路","OTA 空中升级、遥测与日志记录","硬件在环（HIL）测试"]),
    ...
    C["team"] = dict(
      ...
      people=[
        dict(id="stephan-boekelmann", pid=PERSON_STEPHAN, name="Stephan Bökelmann", img="/assets/img/stephan-boekelmann.jpg",
             ...
             role={"de":"Geschäftsführender Gesellschafter · Ingenieur & Physiker","en":"Managing Director · Engineer & Physicist","zh":"总经理 · 工程师与物理学家"}[L],
             ...
             links=[("maxclerkwell.tech","https://maxclerkwell.tech/"),("LinkedIn","https://www.linkedin.com/in/stephan-boekelmann-bochum/"),("GitHub","https://github.com/maxclerkwell"),("ORCID","https://orcid.org/0000-0002-2119-0064")],
             jobTitle=["Managing Director, nabla B","System Architect, skAInet Edge-Compute"], alt=["MaxClerkwell","Stephan Boekelmann","施泓杰"],
             sameAs=["https://www.linkedin.com/in/stephan-boekelmann-bochum/","https://github.com/maxclerkwell","https://orcid.org/0000-0002-2119-0064",
        ...
        dict(id="meihui-huang", pid=PERSON_MEIHUI, name="Meihui Huang", img="/assets/img/meihui-huang.jpg",
             ...
             role={"de":"Physikerin · Werkstudentin · Research und Outreach","en":"Physicist · Working student · Research and Outreach","zh":"物理学家 · 在读学生员工 · 科研与推广"}[L],
